...
import { upLoadFileLibro } from "../FireBase/config";
import Axios from "axios";
import Swal from "sweetalert2";

export const UploadRecurso = () => {
        ...
        Axios.post("http://localhost:3001/createLibro", {
            ...
            .then(() => {
                Swal.fire({
                    ...
                    html: "<i>El libro fue subido con exito!</i>",
                    icon: "success",
                    timer: 3000,
                });
                navigate("/recursos");
    ...
    const handleFileChange = async (e) => {
        ...
        if (selectedFile) {
            ...
            try {
                const result = await upLoadFileLibro(selectedFile)
                setUrl(result);
                setDocumentoSubido(true);
            } catch (error) {
                Swal.fire({
                    title: "<strong>Error!</strong>",
                    html: "<i>Error al cargar el libro.</i>",
                    icon: "error",
                    timer: 3000,
                });
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-5 mx-5 mt-5">
                                ...
                                <p className="fs-4">¡Tu conocimiento es valioso! Comparte tus
                                    ...
                                    alcanzar el éxito académico juntos. Juntos, construimos un camino hacia el
                                        ...
                                        <form onSubmit={handleSubmit(onSubmit)}>
                                            ...
                                            <div className="mb-3">
                                                <div className="input-group">
                                                    ...
                                                    <input {...register('autor', { required: true })} type="text" className="form-control" id="autor" />
                                                </div>
                                                {errors.autor && <span className="text-danger">Este campo es requerido</span>}
                                            </div>
